...
- override subtitle behaviour: show ig.version only when releaselabel is blank, or ig.version - releaselabel when releaselabel is set

## [0.3.1] - 2026-04-29

### Changed

- updated links and references from the old ADHA 'Developer Portal' to the new 'Implementer Hub' `https://implementer.digitalhealth.gov.au/`
